...
-- ============================================================================
-- ASIGNACIÓN FUNCIONARIO ↔ SECTOR DE EVENTO
-- Un funcionario queda asignado a uno o más sectores específicos dentro de un
-- evento.
-- ============================================================================
CREATE TABLE funcionario_evento_sector (
    ...
    UNIQUE KEY uq_func_ev_sec (id_funcionario, id_evento_sector),
    KEY idx_fes_funcionario (id_funcionario),
    KEY idx_fes_evento_sector (id_evento_sector),
    CONSTRAINT fk_fes_funcionario
        FOREIGN KEY (id_funcionario) REFERENCES funcionario_validacion(id_usuario),
    CONSTRAINT fk_fes_evento_sector
        FOREIGN KEY (id_evento_sector) REFERENCES evento_sector(id_evento_sector)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
